...
class ManagementDormitoriesServiceTest {

    private final ManagementDormitoriesService service = new ManagementDormitoriesService();
    ...
    public void testUniqueRoomNumbers() {
        ...
        assertNotNull(result);
        assertEquals(10, result.size());  // We should have 10 unique room numbers
    }
